from PyQt5.QtWidgets import QLabel, QStackedWidget, QWidget, QApplication, QVBoxLayout, QHBoxLayout, QRadioButton, QGridLayout, QPushButton, QSizePolicy
...
class ProblemGui(QWidget):
    ...
    def _initWidget(self):
        ...
        self.main_layout.addWidget(self.stacked_widget, 0, 0, 1, 2)
        ...
        self.main_layout.addWidget(self.line_view, 2, 0, 1, 1)

        self.switch_page_button = QPushButton('Switch to Cost Functions')
        self.main_layout.addWidget(self.switch_page_button, 2, 1, 1, 1)
