...
class Ui_HorizonGUI(object):
    def setupUi(self, HorizonGUI):
        ...
        self.gridLayout_3.addWidget(self.funComboBox, 5, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.funDefaultButton, 6, 0, 1, 2)
        ...
        self.horizontalLayout_2.addWidget(self.funTable)
