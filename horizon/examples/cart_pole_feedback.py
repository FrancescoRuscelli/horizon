...
# Cost function
prb.createCostFunction("track", cs.sumsqr(q - q_init), nodes=range(ns+1))
prb.createCostFunction("damp", 0.01*cs.sumsqr(qdot), nodes=range(ns+1))
prb.createCostFunction("reg", 1e-6*cs.sumsqr(u), nodes=range(ns))
